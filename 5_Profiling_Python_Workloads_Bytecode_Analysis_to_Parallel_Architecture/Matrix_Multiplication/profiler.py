...
def main():
    ...
    pyc_file = r"C:\Users\jaswa\Challenge5\Matrix_Multiplication\__pycache__\matrix_multiplication.cpython-312.pyc"
...
if __name__ == '__main__':
    # Profile the main function and save the stats to a .prof file.
    cProfile.run('main()', 'instruction_counts.prof')